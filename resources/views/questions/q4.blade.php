...
<head>
  ...
  <style>
    ...
    /* ========= Global frame config (samakan di semua halaman) ========= */
    :root{
      --frame-h: 720px;     /* <<< Ubah 1x di sini untuk tinggi konsisten */
      --bg-nudge: 12px;     /* dorong background turun (atasi PNG transparan bawah) */
    }

    /* ========= Movie frame (container TIDAK dianimasikan) =========
       - Lebar dihitung dari tinggi target; dicap ke 100vw
       - Rasio 1052/1543, background 100% 100% (aman karena rasio sama)
       - Background di-nudge agar "nempel" visual
    */
    .movie-frame{
