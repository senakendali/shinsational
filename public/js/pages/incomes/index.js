...
export async function render(target, path, query = {}, labelOverride = null) {
    ...
    target.innerHTML += `
        <div class="d-flex justify-content-between align-items-center mb-3">
            <input class="form-control w-50" type="search" placeholder="Cari pemasukan..." id="searchInput">
    ...
    addBtn.addEventListener("click", () => {
        history.pushState(null, "", "/incomes/create");
    ...
    function loadIncomes(keyword = "", page = 1) {
        showLoader();
        ...
        document.getElementById("income-list").innerHTML = `
            <table class="table table-bordered bg-white">
                <thead>
                    <tr><th colspan="10" class="text-uppercase">Pemasukan</th></tr>
                    <tr>
                        <th>#</th>
                        <th>Tanggal</th>
                        <th>Proyek</th>
    ...
    document
        ...
        .addEventListener("input", function (e) {
            ...
            searchTimeout = setTimeout(() => {
                currentPage = 1;
                loadIncomes(searchKeyword, currentPage);
            }, 300);
        });
...
window.confirmDeleteIncome = function (btn) {
    const id = btn.getAttribute("data-id");
    const name = btn.getAttribute("data-name");
    const messageEl =
        document.getElementById("delete-message") ||
        document.createElement("div");
    messageEl.textContent = `Yakin ingin menghapus pemasukan "${name}"?`;
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <p id="delete-message">Yakin ingin menghapus pemasukan ini?</p>
                        </div>
    ...
    confirmBtn.onclick = async () => {
        ...
        try {
            ...
            modal.hide();
            render(document.getElementById("app"), "/incomes");
        } catch (err) {
