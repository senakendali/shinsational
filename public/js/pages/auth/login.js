...
export function render(target, params, query = {}, labelOverride = null) {
    ...
    target.innerHTML = `
    <div class="vh-100 bg-light d-flex align-items" 
      ...
      <div class="container-fluid">
        <div class="row g-0 h-100">
          ...
          <!-- Right side (form) -->
          <div class="col-md-6 d-flex justify-content-end align-items-center  " style="padding-right:7rem;">
            <div class="pt-5 ">
              <div class="mb-3">
        ...
        .then(([authMod, loaderMod, toastMod, formMod]) => {
            ...
            form.addEventListener("submit", async (e) => {
                ...
                try {
                    ...
                    if (err?.status === 419)
                        showToast("Sesi kadaluarsa, refresh dulu ya.", "error");
                } finally {
                    hideLoader();
