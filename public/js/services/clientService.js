...
export const clientService = {
  ...
  async get(id) {
    ...
    if (!res.ok) throw new Error('Gagal mengambil detail klien');
    return await res.json();
  },
  ...
  async create(formData) {
    ...
    if (!res.ok) {
      ...
      throw { message: error.message || 'Gagal membuat klien', errors: error.errors || {} };
    }
  ...
  async update(id, formData) {
    ...
    if (!res.ok) {
      const error = await res.json();
      throw { message: error.message || 'Gagal mengupdate klien', errors: error.errors || {} };
    }
